...
{
    public class InfoButtonWidgetController : MonoBehaviour
    {
        public event EventHandler MainBtnPointerClicked_EventHandler;
        public InfoButtonWidgetProperties Props { get => _props; }
        ...
        private InfoButtonWidgetProperties _props;
        ...
        public void SetData(InfoButtonWidgetProperties props)
        {
            _props = props;
        ...
        public void Refresh(InfoButtonWidgetProperties props)
        {
            SetData(props);
        }
