...
{
    public class MoveButtonWidgetController : MonoBehaviour
    {
        public event EventHandler MainBtnPointerClicked_EventHandler;
        public MoveButtonWidgetProperties Props { get => _props; }
        ...
        private MoveButtonWidgetProperties _props;
        ...
        public void SetData(MoveButtonWidgetProperties props)
        {
            _props = props;
        ...
        public void Refresh(MoveButtonWidgetProperties props)
        {
            SetData(props);
        }
