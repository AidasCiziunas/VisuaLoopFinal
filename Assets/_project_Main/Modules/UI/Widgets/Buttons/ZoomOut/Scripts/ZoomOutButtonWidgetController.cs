...
{
    public class ZoomOutButtonWidgetController : MonoBehaviour
    {
        ...
        private ZoomOutButtonWidgetProperties _props;
        ...
        public void SetData(ZoomOutButtonWidgetProperties props)
        {
            _props = props;
        ...
        public void Refresh(ZoomOutButtonWidgetProperties props)
        {
            SetData(props);
        }
