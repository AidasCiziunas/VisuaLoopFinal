...
{
    public static class CacheModuleSignals
    {
        private static readonly CacheModuleSignalHub hub = new CacheModuleSignalHub();
    ...
    public abstract class CacheModuleABaseSignal : ISignal
    {
    ...
    public class CacheModuleSignalHub
    {
    ...
    public abstract class CacheModuleASignal : CacheModuleABaseSignal
    {
        ...
        public void Dispatch()
        {
            ...
            {
                CacheModuleSignals.GenerateDebugForEmptySignal(Hash);
            }
        }
    }

    public abstract class CacheModuleASignal<R> : CacheModuleABaseSignal
    {
    ...
    public abstract class CacheModuleASignal<T, R> : CacheModuleABaseSignal
    {
    ...
    public abstract class CacheModuleASignal<T, Q, R> : CacheModuleABaseSignal
    {
    ...
    public abstract class CacheModuleASignal<T, Q, S, R> : CacheModuleABaseSignal
    {
    ...
    public abstract class CacheModuleASignal<T, Q, S, W, R> : CacheModuleABaseSignal
    {
        private Func<T, Q, S, W, R> callback;

        public void AddListener(Func<T, Q, S, W, R> handler)
        {
#if UNITY_EDITOR
            UnityEngine.Debug.Assert(
                handler.Method.GetCustomAttributes(typeof(System.Runtime.CompilerServices.CompilerGeneratedAttribute),
        ...
        public void RemoveListener(Func<T, Q, S, W, R> handler)
        {
            callback -= handler;
        }

        public R Dispatch(T arg1, Q arg2, S arg3, W arg4)
        {
            if (callback != null)
            {
    ...
    public abstract class CacheModuleASignal<T, Q, W, S, Y, R> : CacheModuleABaseSignal
    {
