...
namespace SyedAli.Main
{
    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        public bool IsThisWindowOpened(ScreenIds screenIds)
        {
            return windowLayer.IsThisWindowOpened(screenIds);
        }

        public bool IsThisWindowTopOfWindows(IWindowController windowController)
        {
            return windowLayer.IsThisWindowTopOfWindows(windowController);
        }

        public IWindowController GetTopOfWindows()
        {
            return windowLayer.GetTopOfWindows();
        }
