...
{
    public class ScreenShowAnimation : ATransitionComponent
    {
        [SerializeField] UIAnimator _uIAnimator;
        [SerializeField] bool _onShowMoveScreenOutOfBound = true; //When it is false, then we can test the standalone screen without worrying of already going out of bounds in test canvas
        ...
        private void Awake()
        {
            ...
            if (_onShowMoveScreenOutOfBound)
            {
